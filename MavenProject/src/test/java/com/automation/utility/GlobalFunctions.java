...
public class GlobalFunctions extends ReporterManager{
	
///	public static WebDriver driver;
	public static Map<String, String> data;
	static public final int DRIVER_IMPLICIT_WAIT = 30;
	...
	public static By getLocator(String input){
			  ...
			  if(input.startsWith("LT::"))
				  value = By.linkText(input.substring(4));
			  ...
			  if(input.startsWith("CLASSNAME::"))
				  value = By.className(input.substring(11));
			  if(input.startsWith("NAME::"))
				  value = By.name(input.substring(6));
			  if(input.startsWith("TGN::"))
				  value = By.tagName(input.substring(5));
	...
	//    @Parameters("browser")
		 public static WebDriver launchBrowser(WebDriver driver) throws Exception {
		    ...
		    // System.setProperty("webdriver.chrome.driver","C:\\Users\\Dhanu\\Desktop\\chromedriver.exe");
		     System.setProperty("webdriver.chrome.driver",System.getProperty("user.dir")+"\\Library\\chromedriver.exe");
		    // System.setProperty("webdriver.chrome.driver",System.getProperty("user.dir")+"\\Library\\chromedriver.exe");	
		     System.setProperty("webdriver.ie.driver",System.getProperty("user.dir")+"\\Library\\\\chromedriver.exe");
		     
		        
		      //  System.setProperty("webdriver.gecko.driver",System.getProperty("user.dir")+"\\Library\\geckodriver.exe");
		        System.setProperty("webdriver.firefox.marionette",System.getProperty("user.dir")+"\\Library\\geckodriver.exe");
    ...
    /** Method Deals To Open URL Browser  **/
		 ...
		 /** Method Deals To Synchronization **/
			...
			public static WebDriver takeScreenshot(String EnterScreenName) throws Exception {	
				...
				FileUtils.copyFile(file, new File(System.getProperty("user.dir")+"\\DataFiles\\"+ "\\Screen Shorts\\"+EnterScreenName+time+".png"));
				return driver;		
			}
			...
			public static WebDriver CaptureScreenShot(ITestResult result, String methodname){
				  ...
				  Date d=new Date();
				  String time=df.format(d);
		    	  WebDriver driver=ReporterManager.driver;   
		          File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		                                        
		          try {
		                 FileUtils.copyFile(scrFile, new File(System.getProperty("user.dir")+"\\DataFiles\\"+ "\\Failed Screen Shots\\"+methodname+" "+time+".png"));
		                 test.log(
		         				LogStatus.INFO,
		         				"Error Snapshot : "
		         						+ test.addScreenCapture(System.getProperty("user.dir")+"\\DataFiles\\"+ "\\Failed Screen Shots\\"+methodname+" "+time+".png"));
		          }
		          catch (IOException e) {
		               e.printStackTrace();
		          }
      ...
      /** For driver close **/
      public static WebDriver close(WebDriver driver){
    	  driver.close();	  
		return driver;	  
      }
   ...
   // 	    data=DataReader.readData();
     ...
     // 	  data=DataReader.readData();
      ...
      public static WebDriver sendkeys(WebDriver driver,String passlocator,String EnterText) throws Exception{
    	...
    	//  data=DataReader.readData();
      	  ...
      	  driver.findElement(GlobalFunctions.getLocator(passlocator)).sendKeys(EnterText);
    ...
    //	  data=DataReader.readData();
    	  ...
    	  Connection connection = DriverManager.getConnection("jdbc:sqlserver://Vertiv.Net;database=Applaud_QA;","applaud", "aplaud@2017");
   ...
   //   	  data=DataReader.readData();
     ...
     //Login to the webapplication using Robot class
