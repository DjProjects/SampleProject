...
public abstract class ReporterManager extends GlobalObjects{
...
//    protected WebDriver driver;
    ...
    extent = new ExtentReports(System.getProperty("user.dir")+"\\DataFiles\\"+ "\\Report Manager\\"+"automation"+time+".html", true);  
	 extent.config()
     .documentTitle("AppLaudGS")
     .reportName("Project Automation Reports");
	 extent
	 .addSystemInfo("Host Name", "Dhananjaya Reddy")
